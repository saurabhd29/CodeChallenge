...
Find out whether they touch(at one or more than one points).
        ...
        If C1C2 <= R1 – R2: august.Circle B is inside A.
If C1C2 <= R2 – R1: august.Circle A is inside B.
If C1C2 < R1 + R2: august.Circle intersects each other.
If C1C2 == R1 + R2: august.Circle A and B are in touch with each other.
*/
